...
Source: Wikipedia (https://en.wikipedia.org/wiki/Automated_decision-making)
...
In a recent book french authors Olivier Sibony and Éric Hazan, Faut-il encore décider ? La décision humaine à l'ère de l'intelligence artificielle (Flammarion, 2026) examine the growing tension between algorithmic recommendations and human judgment. The book questions which decisions can be delegated to machines and which must remain a fundamentally human and political responsibility.
...
In the United Kingdom, the Data (Use and Access) Act 2025 amended Article 22 of the UK GDPR, replacing the general prohibition on solely automated decisions with significant effects with a conditions-based approach requiring organisations to implement safeguards including meaningful human review and the right to contest decisions. The Information Commissioner's Office (ICO) launched an AI and biometrics strategy in 2025 with automated decision-making as a primary enforcement focus. Its March 2026 findings from engaging with over 30 employers concluded that most organisations do not recognise they are making solely 
automated decisions without the required safeguards.
