...
Source: Wikipedia (https://en.wikipedia.org/wiki/Local_case-control_sampling)
...
Marginal Imbalance. A dataset is marginally imbalanced if one class is rare compared to the other class. In other words, 
    ...
    {\displaystyle \mathbb {P} (Y=1)\approx 0}
...
, the dataset is conditionally imbalanced if 
    ...
    {\displaystyle \mathbb {P} (Y=1\mid X=0)\approx 0}
 ...
 and 
    ...
    {\displaystyle \mathbb {P} (Y=1\mid X=1)\approx 1}
...
Generate independent 
    ...
    {\displaystyle z_{i}\sim {\text{Bernoulli}}(a(x_{i},y_{i}))}
...
Fit a logistic regression model to the subsample 
    ...
    {\displaystyle S=\{(x_{i},y_{i}):z_{i}=1\}}
...
, obtaining the unadjusted estimates 
    ...
    {\displaystyle {\hat {\theta }}_{S}=({\hat {\alpha }}_{S},{\hat {\beta }}_{S})}
...
The output model is 
    ...
    {\displaystyle {\hat {\theta }}=({\hat {\alpha }},{\hat {\beta }})}
...
, where 
    ...
    {\displaystyle {\hat {\alpha }}\leftarrow {\hat {\alpha }}_{S}+{\tilde {\alpha }}}
 ...
 and 
    ...
    {\displaystyle {\hat {\beta }}\leftarrow {\hat {\beta }}_{S}+{\tilde {\beta }}}
