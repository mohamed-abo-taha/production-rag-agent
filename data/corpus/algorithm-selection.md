...
Source: Wikipedia (https://en.wikipedia.org/wiki/Algorithm_selection)
...
, the algorithm selection problem consists of finding a mapping 
 ...
 across all instances is optimized.
...
-hard problems (such as mixed integer programming, CSP, AI planning, TSP, MAXSAT, QBF and answer set programming). Competition-winning systems in SAT are SATzilla, 3S and CSHC
