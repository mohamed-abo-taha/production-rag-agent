...
Source: Wikipedia (https://en.wikipedia.org/wiki/Linear_separability)
...
Let 
    ...
    {\displaystyle X\subset \mathbb {R} ^{d}}
 ...
 points and 
    ...
    {\displaystyle Y\subset \mathbb {R} ^{d}}
...
-dimensional Euclidean space. 
 ...
 are linearly separable if they can be "separated" by a 
...
-dimensional hyperplane such that every point in 
 ...
 lies on one side of the hyperplane and every point in 
...
The separating hyperplane is composed of points 
    ...
    {\displaystyle \left\{z\in \mathbb {R} ^{d}:w^{\top }z+k=0\right\}}
...
, where 
 ...
 are linearly separable if there exists a normal vector 
...
Such functions are also called linear threshold logic, or perceptrons. The classical theory is summarized in, as Knuth claims.
The number of Boolean functions which are linearly separable is only known exactly up to the 
...
== Threshold logic ==
A linear threshold logic gate is a Boolean function defined by 
...
, and outputs 1 if 
    ...
    {\displaystyle \sum _{i}w_{i}x_{i}>\theta }
...
, because there are only finitely many Boolean functions that can be computed by a threshold logic unit, it is possible to set all 
    ...
    {\displaystyle w_{1},\dots ,w_{n},\theta }
 ...
 such that every possible real threshold function of 
...
. It is known that
    ...
    {\displaystyle {\frac {1}{2}}n\log n-2n+o(n)\leq \log _{2}W(n)\leq {\frac {1}{2}}n\log n-n+o(n)}
  
See  for a literature review.
