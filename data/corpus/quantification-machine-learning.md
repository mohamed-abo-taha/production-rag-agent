...
Source: Wikipedia (https://en.wikipedia.org/wiki/Quantification_%28machine_learning%29)
...
Methods that can deal with both the binary case and the single-label multiclass case include probabilistic classify and count (PCC), adjusted classify and count (ACC), probabilistic adjusted classify and count (PACC), the Saerens-Latinne-Decaestecker EM-based method (SLD), and KDEy.
...
Quantification of networked data. This task consists of performing quantification when the datapoints are members of a relation, i.e., are interlinked. As such, this task is a strict relative of collective classification.
...
measuring classifier bias and ranker bias,
