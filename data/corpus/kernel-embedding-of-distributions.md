...
Source: Wikipedia (https://en.wikipedia.org/wiki/Kernel_embedding_of_distributions)
...
Let 
    ...
    {\displaystyle {\mathcal {X}}\subseteq \mathbb {R} ^{b}}
...
. An MMD based test was the first test shown to be asymptotically optimal for two-sample hypothesis testing.
