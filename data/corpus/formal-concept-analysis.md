...
Source: Wikipedia (https://en.wikipedia.org/wiki/Formal_concept_analysis)
...
A′ = {m ∈ M | ∀ g ∈ A . (g,m) ∈ I}, i.e., a set of all attributes shared by all objects from A, and dually
B′ = {g ∈ G | ∀ m ∈ B . (g,m) ∈ I}, i.e., a set of all objects sharing all attributes from B.
...
Triadic concept analysis replaces the binary incidence relation between objects and attributes by a ternary relation between objects, attributes, and conditions. An incidence ⁠
...
Demo Archived 2013-07-25 at the Wayback Machine
