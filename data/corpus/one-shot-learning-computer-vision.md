...
Source: Wikipedia (https://en.wikipedia.org/wiki/One-shot_learning_%28computer_vision%29)
...
. To reduce the number of hypotheses in the hypothesis space 
...
Biederman, I. (1987). "Recognition-by-Components: a theory of human understanding" (PDF). Psychological Review. 94 (2): 115–147. doi:10.1037/0033-295X.94.2.115. PMID 3575582. Archived from the original (PDF) on 2022-11-29. Retrieved 2021-11-21.
...
Bart; Ullman (2005). "Cross-generalization: learning novel classes from a single example by feature replacement" (PDF). CVPR. Archived from the original (PDF) on 2022-12-06. Retrieved 2021-11-21.
