...
Federated Proximal (FedProx) extends FedAvg by adding a proximal term to the local objective in the form of 
    ...
    {\displaystyle {\frac {\mu }{2}}\|w-w^{t}\|^{2}}
...
, where 
 ...
 is the FedProx hyper parameter, in order to address data heterogeneity across clients.  The proximal term constrains local updates, helping reduce client drift when client data are non-IID.
